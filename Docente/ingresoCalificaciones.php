    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
              <label class="col-md-4 control-label" for="txtNumExamen">Número de Examen</label>  
              <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
              <label class="col-md-4 control-label" for="txtNumAcumulativo">Número de Acumulativo</label>  
              <div class="col-md-6">
          ...
          <div class="form-group">
           <div class="col-md-6">
            <div class="input-group">
              ...
              <input id="txtTotalExamenes" name="txtTotalExamenes" type="text" placeholder="Automático" class="form-control input-md">  
            </div>    
          </div>
          </div>
          ...
          <div class="form-group">
           <div class="col-md-6">
            <div class="input-group">
              ...
              <input id="txtTotalAcumulativo" name="txtTotalAcumulativo" type="text" placeholder="Automático" class="form-control input-md">  
            </div>
            </div>
          </div>
