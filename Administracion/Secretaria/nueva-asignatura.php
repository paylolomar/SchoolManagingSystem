...
<body id="home">
		...
		<div class="container">
			...
			            <div class="form-group">
							<div class="col-lg-6">
								...
								<input type="text" class="CodAsignatura form-control" name="CodAsignatura" placeholder="Ingrese el código para la nueva asignatura." />
							</div>					
						</div>
			            <div class="form-group">
							<div class="col-lg-6">
								<label>Nombre Asignatura:</label>
								<input type="text" class="NomAsignatura form-control" name="NomAsignatura" placeholder="Ingrese el nombre para la nueva asignatura." />	
							</div>
						</div>
	...
	<script type="text/javascript" src="../../js/funcionesNuevaAsignatura.js"></script>
