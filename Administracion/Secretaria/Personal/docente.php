...
<body id="home">
		<form class="form-vertical">
			...
			<div class="row">
				...
				<a onClick="return popitup('/Proyecto/administracion/secretaria/personal/docente-contratacion.php')"><button class="btn-primary">Nuevo Docente</button></a>
				</div>
			</div>	
			</br>
			<div class="row">
				<div class="col-sm-12 text-center">
				<a onClick="return popitup('/Proyecto/administracion/secretaria/personal/docente-edicion.php')"><button class="btn-primary">Editar Docente</button></a>
				</div>
			</div>
