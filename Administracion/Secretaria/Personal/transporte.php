...
<body id="home">
		<form class="form-vertical">
			...
			<div class="row">
				...
				<a onClick="return popitup('/Proyecto/administracion/secretaria/personal/transporte-contratacion.php')"><button class="btn-primary">Nuevo Personal de Transporte</button></a>
				</div>
			</div>	
			</br>
			<div class="row">
				<div class="col-sm-12 text-center">
				<a onClick="return popitup('/Proyecto/administracion/secretaria/personal/transporte-edicion.php')"><button class="btn-primary">Editar Personal de Transporte</button></a>
				</div>
			</div>
