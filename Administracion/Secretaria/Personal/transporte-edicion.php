...
<body id="home">
		<form class="form-vertical">
			  <fieldset>
			     <legend>Editar Personal de Transporte</legend>
				...
				<div class="form-group">
			      ...
			      <div class="col-lg-10">
			        ...
			        <label class="col-lg-2 control-label">Turnos</label>
			        	<br />
						<input name="cbprimero" type="checkbox" />Matutina 
						<br />
						<input name="cbsegundo" type="checkbox" />Vespertina
						<br />
			        ...
			        <label for="select" class="col-lg-2 control-label">Vehículo Asignado</label>
			        <select class="form-control">
			          <option>Toyota Hiace o numero de placa</option>
			          <option>Nissan Urban o numero de placa</option>
			          <option>Bus amarillo o numero de placa</option>
			          <option>Toyota Coaster o numero de placa</option>
			        </select>	
				...
				<div class="form-group">
			      <div class="col-lg-10 col-lg-offset-2">
			        ...
			        <button type="submit" class="btn btn-warning">Elminar de Personal de Transporte</button>
			        <button type="submit" class="btn btn-primary">Agregar a Personal de Transporte</button>
			      </div>
			    </div>
			  </fieldset>
			</form>
