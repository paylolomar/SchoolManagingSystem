	...
	<div id="nuevo-curso" class="content-section-b" style="border-top: 0">
		<div class="container">
			<div class="col-md-6 col-md-offset-3 text-center wrap_title">
				<h4>Modificar/Eliminar Sección</h4>
			</div>
				...
				<form class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-lg-12">
							<input type="text" class="form-control" id="txtNomSección" placeholder="Nombre Sección" required="">	
						</div>
					</div>
					    
					<div class="btn-group btn-group-justified">
					  <a id="btn-modificarSeccion" class="btn btn-default btn-sm" style="background-color:#E28700; border-color:#FFFFFF">Modificar</a>
					  <a id="btn-eliminarSeccion" class="btn btn-default btn-sm" style="background-color:#CB171E; border-color:#FFFFFF">Eliminar</a>
