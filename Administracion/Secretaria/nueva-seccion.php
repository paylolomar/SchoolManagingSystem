...
            <div class="form-group">
				<div class="col-lg-6">
					...
					<input type="text" class="CodSeccion form-control" name="CodSeccion" placeholder="Ingrese el código para la nueva sección." />
				</div>					
			</div>
            <div class="form-group">
				<div class="col-lg-6">
					<label>Nombre Sección:</label>
					<input type="text" class="NomSeccion form-control" name="NomSeccion" placeholder="Ingrese el nombre para la nueva sección." />	
				</div>
			</div>
...
     </form>
	...
	<script type="text/javascript" src="../../js/funcionesNuevaSeccion.js"></script>
