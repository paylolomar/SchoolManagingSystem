...
<body id="home">
		<form class="form-vertical">
			  <fieldset>
			    ...
			    <div class="form-group">
			      <label for="inputPassword" class="col-lg-2 control-label">Numero de titulo</label>
			      <div class="col-lg-10">
			        <input type="text" class="form-control" id="inputPassword" placeholder="Ej. 1474">
			      </div>
			    </div>
				
				<div class="form-group">
			      <label  class="col-lg-2 control-label">Promoción</label>
			      <div class="col-lg-10">
			        <input type="text" class="form-control" id="inputPassword" placeholder="Ej. Sir. Nelson Moncada">
			      </div>
			    </div>
				...
				<br>
			        ...
			        <label for="select" class="col-lg-2 control-label">Extendido por:</label>
			        <select class="form-control">
			          <option>Graduación de colegio</option>
			          <option>Graduación de escuela</option>
			        </select>	
			    ...
			    <div class="form-group">
			      ...
			      <div class="col-lg-10">
			        ...
			        <span class="help-block">cualquier tipo de observacion incluidas: daños, estado, etc.</span>
			      </div>
			    </div>
				...
				<div class="form-group">
			      <div class="col-lg-10 col-lg-offset-2">
			        ...
			        <button type="submit" class="btn btn-primary">Agregar a almacen de titulos</button>
			      </div>
			    </div>
			  </fieldset>
			</form>
